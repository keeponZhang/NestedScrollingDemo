...
public class MeasureLayoutBehavior2 extends CoordinatorLayout.Behavior<View> {
    ...
    public MeasureLayoutBehavior2() {
    }

    public MeasureLayoutBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
